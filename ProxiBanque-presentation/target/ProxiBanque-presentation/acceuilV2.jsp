	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-10 text-left">
				...
				<c:choose>
					<c:when test="${listeClient.equals([])}">
						<h3 class="text-center">Vous ne possédez pas encore de clients.</h3>
					</c:when>
					<c:otherwise>
